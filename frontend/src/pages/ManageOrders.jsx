...
const ManageOrders = () => {
  ...
  const handleShow = () => {
    setFormData({
      ...
      assignedEmployee: '', advanceReceived: false, paymentMethod: '', printingCompany: '', isClientOrder: false, items: [{ itemName: '', totalQty: 1, price: 0 }]
    });
    setFile(null);
    setError('');
    setShowModal(true);
  ...
  const handleExportMonthlyReport = () => {
    ...
    const reportOrders = walkInOrders.filter(o => {
